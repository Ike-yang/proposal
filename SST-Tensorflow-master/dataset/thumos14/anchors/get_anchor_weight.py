...
feature_path = '../features/sub_activitynet_v1-3.c3d.hdf5'
...
split = 'train'
proposal_file_path = os.path.join(proposal_source, '%s.json'%split)
...
sample_len = 4096/8 # length of sampled stream, measured in feature number 
...
split = 'train'
split_data = json.load(open(os.path.join(proposal_source, 'train.json')))
