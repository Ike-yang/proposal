...
def default_options():
    ...
    #*** DATA ***#
    options['feature_data_path'] =  'dataset/thumos14/features/sub_activitynet_v1-3.c3d.hdf5'   # path to feature data
    ...
    options['c3d_resolution'] = 8   # resolution in frames (16 frames per feature)

    #*** MODEL CONFIG ***#
    options['video_feat_dim'] = 500 # dim of video feature
    ...
    options['num_anchors'] = 16      # number of anchors
